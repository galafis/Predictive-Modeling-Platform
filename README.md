...
**Predictive Modeling Platform** — Professional project by Gabriel Demetrios Lafis

Total source lines: **883** across **6** files in **5** languages.
...
Total de linhas de código: **883** em **6** arquivos em **5** linguagens.
